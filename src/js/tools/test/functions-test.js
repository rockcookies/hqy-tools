...
QUnit.test('partial', function(assert) {
	...
	var originalPlaceholder = _.partial.placeholder;
    ...
    _.partial.placeholder = originalPlaceholder;
});
...
QUnit.test('bindAll', function(assert) {
	...
	moe = {
		...
		getName: function() { return 'name: ' + this.name; },
		sayHi: function() { return 'hi: ' + this.name; },
		sayLast: function() { return this.sayHi(arguments.length && arguments[arguments.length - 1]); }
	};
